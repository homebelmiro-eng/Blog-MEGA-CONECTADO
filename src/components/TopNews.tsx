  ...
  return (
    <section className="mb-20">
      <div className="flex items-center gap-2 mb-8">
        ...
        <h2 className="font-heading font-bold text-2xl text-brand-primary uppercase tracking-tight">Top News em Tecnologia</h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {topNewsArticles.map((article) => (
          <article key={article.id} className="group cursor-pointer flex flex-col h-full bg-white border border-slate-200 rounded-xl overflow-hidden hover:border-brand-secondary hover:shadow-sm transition-all duration-300">
